...
void CMouseUI::walking(void)
{
    ...
    do {
        ...
        case 'h':
            ...
            break;
        case 'i':
            maus.ReceiveMsg(CMouseCom::InitMouse);
            break;
        case'y':
            //gait.store(GotoSTOP);
            break;
...
void CMouseUI::setServoAngle(void){
...
void CMouseUI::setServoDutycycle(void){
